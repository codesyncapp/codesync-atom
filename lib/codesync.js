...
import { CONFIG_PATH, STATUS_BAR_MSGS } from "./constants";
import { handleChanges, handleFileCreated, handleFileDeleted,
  handleFileRenamed } from "./events/event_handler";
import { setupCodeSync } from "./utils/setup_utils";
import { SignUpHandler, SyncHandler, trackFileHandler, unSyncHandler } from "./handlers/commands_handler";
...
export default {
  ...
  async activate(state) {
    ...
    this.subscriptions.add(atom.contextMenu.add({'atom-text-editor': [{
      label: 'View File Playback on CodeSync',
