...
// Dummy content
export const handleBuffer = async (statusBarItem) => {
    /*
    ...
    */
    try {
        ...
        repoDiffs.forEach((repoDiff) => {
            // Creating socket connection per repo
                        ...
                        if (resp.type === 'auth') {
                            ...
                            for (const fileToDiff of repoDiff.file_to_diff) {
                                ...
                                if (diffData.is_rename) {
                                    ...
                                    if (newFiles.includes(oldRelPath)) {
                                        continue;
                                    }
                                ...
                                if (!fileId && isDeleted) {
                                    ...
                                    putLogEvent(`is_deleted non-synced file found: ${path.join(diffData.repo_path, relPath)}`, configRepo.email);
