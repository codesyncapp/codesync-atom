...
export class DiffHandler {
    ...
    constructor(fileRelPath, diffData, diffFilePath, accessToken) {
    ...
    sendDiffToServer(webSocketConnection, diffToSend) {
        // Send diff to server
    ...
    static removeDiffFile(diffFilePath) {
