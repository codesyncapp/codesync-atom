...
export function shouldIgnorePath(repoPath, relPath) {
...
export const isRepoSynced = (repoPath, checkFileIds=true) => {
	...
	try {
		...
		CodeSyncState.set(CODESYNC_STATES.REPO_IS_IN_SYNC, true);
		return true;
	} catch (e) {
		return false;
	}
