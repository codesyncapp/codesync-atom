...
import { getRepoInSyncMsg, NOTIFICATION, SYNCIGNORE} from '../constants';
...
export const postSelectionUnsync = async (repoPath, notification) => {
	...
	if (json.error) {
		...
		CodeSyncState.set(CODESYNC_STATES.IS_SUB_DIR, false);
		CodeSyncState.set(CODESYNC_STATES.IS_SYNCIGNORED_SUB_DIR, false);
