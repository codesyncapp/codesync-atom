...
export class initUtils {
	...
	static getSyncablePaths (repoPath, userPlan) {
	...
	static async uploadRepo(repoPath, repoName, branch, token, isPublic, itemPaths, userEmail, isRepoSynced=false, viaDaemon=false) {
		const configJSON = readYML(CONFIG_PATH);
