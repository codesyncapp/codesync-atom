...
import { getDirectorySyncIgnoredMsg, NOTIFICATION } from '../constants';
...
export const showSyncIgnoredRepo = (repoPath, parentRepoPath) => {
	const msg = getDirectorySyncIgnoredMsg(repoPath, parentRepoPath);
    atom.notifications.addInfo(msg, {
        buttons: [
			{
				text: NOTIFICATION.OPEN_SYNCIGNORE,
                onDidClick: openSyncIgnoreHandler
			},
            {
            ...
            {
				text: NOTIFICATION.UNSYNC_PARENT_REPO,
